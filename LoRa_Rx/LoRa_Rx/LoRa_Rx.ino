...
void setup()
{
  ...
  if (!manager.init())
    ...
    SerialUSB.println("RF22 init success");
 ...
 attachInterrupt(digitalPinToInterrupt(6), handler, CHANGE);
}
...
void loop()
{
  ...
  //     // Send a reply
  //     uint8_t toSendDummy[] = "Dummy Payload!"; 
  //     rf95.send(toSendDummy, sizeof(toSendDummy));
  //     rf95.waitPacketSent();
  //     uint8_t toSendMain[] = "Main Payload!"; 
  //     rf95.send(toSendMain, sizeof(toSendMain));
  //     rf95.waitPacketSent();
